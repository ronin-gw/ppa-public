...
---
1. 数値解析手法
2. 浮動小数点の扱い方については，p1-3, p2-4を参照のこと．
3. 浮動小数点における精度については，p2-4の末尾を参照のこと．
4. 関数の宣言・定義方法については，p2-1, p2-2を参照のこと．
5. 関数への配列の渡し方については，p3-1を参照のこと．
6. 動的メモリ確保については，p3-2を参照のこと．
---
## 導入文
---
